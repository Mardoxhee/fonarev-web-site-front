...
const AppelCard = ({titre, expiration, reference, link}) => {
  return (
            ...
            <div className={styles.textSide}>
                ...
                <div className={styles.inContainer}>
                    ...
                    <div className={styles.ctaFlexer}>
                        <h4 className={styles.timeExp}><Icon icon="uim:calender" className={styles.icone} /> Date d'expiration  : {expiration}</h4>
