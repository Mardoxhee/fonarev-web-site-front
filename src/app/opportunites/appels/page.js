          ...
          <section className={styles.subtitle}>
            ...
            {/* <Suspense fallback={<div>Chargement...</div>}>
              <AppelCard isAvis={false} bigTitle="..." />
                ...
                <AppelCard isAvis = {true}  bigTitle = "AVIS D'APPEL D'OFFRES NATIONAL SANS PREQUALIFICATION publié le vendredi 18 Mars 2025" link="/FONAREV-AON-CALL-CENTER.pdf" reference = "AAON N°04-S/PG FONAREV/CGPMP/PF/03-2025" expiration = "Le 21 Avril 2025" titre = "Sélection d'une agence chargée de la gestion du centre d'appel (call center) externalisé du FONAREV et du numéro vert dédié"  />
