          ...
          <section className={styles.subtitle}>
            ...
            <div className={styles.contentGrid}>
              <div className={styles.listColumn}>
                ...
                <AppelCard variant="compact" isAvis = {true}  bigTitle = "AVIS D'APPEL D'OFFRES publié le 14 janvier 2026" link="/AAO-CONTRUCTION-D-UN-CENTRE-DES-VICTIMES-TSHOPO.pdf" reference = "AAOI N° 01- S/DG FONAREV/CGPMP/PF/12-2025" expiration = "Le 13 février 2026" titre = "MARCHE DES TRAVAUX DE CONSTRUCTION D'UN CENTRE DES VICTIMES DANS LA PROVINCE DE LA TSHOPO" />
