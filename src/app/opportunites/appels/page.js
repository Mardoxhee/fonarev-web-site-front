          ...
          <section className={styles.subtitle}>
            ...
            {/* <Suspense fallback={<div>Chargement...</div>}>
              <AppelCard isAvis={false} bigTitle="..." />
                ...
                <AppelCard isAvis = {true}  bigTitle = "AVIS D'APPEL À CANDIDATURE  publié le mardi 31 Octobre 2025" link="/AMI-Recrutement-consultanthgr.pdf" reference = "AMI N°29-PI/DG FONAREV/CGPMP/PF/10-2025" expiration = "Le 01 Décembre 2025" titre = "RECRUTEMENT D'UN CONSULTANT FIRME EN CHARGE DE LA REALISATION DES ÉTUDES, DU CONTRÔLE ET DE L A SURVEILLANCE DES TRAVAUX LA RÉHABILITATION DES HÔPITAUX GÉNÉRAUX DANS LA PROVINCE DU KASAÏ CENTRAL"/>
