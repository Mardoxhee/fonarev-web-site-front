     ...
     <meta name="keywords" content="victimes,violences sexuelles, Etat congolais, guerre à l'est, réparation des victimes,réparation, aide aux victimes, soutien victiles, préjudices, massacre, republique democratique du congo, tuerie, minrais, 11%, redévance" />
        ...
        <main className={styles.main}>
          ...
          <section className={styles.subtitle}>
            ...
            <AppelCard isAvis = {false}  bigTitle = "Avis d'Appel d'Offres International  publié le Marcredi 12 Juin 2024" link="/avis-appel-offre-international.pdf" reference = "AOI N° 002- F/ DG FONAREV/ CPM/ DMIL/ 06- 2024" expiration = "Jusqu'au 12 juillet 2024 à 14h00'" titre = "MARCHE DE FOURNITURES" />
